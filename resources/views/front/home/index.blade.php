              ...
              <div class="tab-pane fade" id="tab1-2" role="tabpanel">
                <div class="row">
                  <div class="col-sm-6 p-r-25 p-r-15-sr991">
                    ...
                    <div class="m-b-30">
                      <a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
                        <img src="{{ asset('front_asset/images/post-09.jpg') }}" alt="IMG">
                      </a>
              ...
              <div class="tab-pane fade show active" id="tab2-1" role="tabpanel">
                <div class="row">
                  ...
                  <div class="col-sm-6 p-r-25 p-r-15-sr991">
                    ...
                    <div class="flex-wr-sb-s m-b-30">
                      <a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
                        <img src="{{ asset('front_asset/images/post-12.jpg') }}" alt="IMG">
                      </a>
                    ...
                    <div class="flex-wr-sb-s m-b-30">
                      <a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
                        <img src="{{ asset('front_asset/images/post-13.jpg') }}" alt="IMG">
                      </a>
              ...
              <div class="tab-pane fade show active" id="tab3-1" role="tabpanel">
                <div class="row">
                  ...
                  <div class="col-sm-6 p-r-25 p-r-15-sr991">
                    ...
                    <div class="flex-wr-sb-s m-b-30">
                      <a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
                        <img src="{{ asset('front_asset/images/post-15.jpg') }}" alt="IMG">
                      </a>
                    ...
                    <div class="flex-wr-sb-s m-b-30">
                      <a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
                        <img src="{{ asset('front_asset/images/post-16.jpg') }}" alt="IMG">
                      </a>
                    ...
                    <div class="flex-wr-sb-s m-b-30">
                      <a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
                        <img src="{{ asset('front_asset/images/post-17.jpg') }}" alt="IMG">
                      </a>
              ...
              <div class="tab-pane fade" id="tab3-2" role="tabpanel">
                <div class="row">
                  ...
                  <div class="col-sm-6 p-r-25 p-r-15-sr991">
                    ...
                    <div class="flex-wr-sb-s m-b-30">
                      <a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
                        <img src="{{ asset('front_asset/images/post-18.jpg') }}" alt="IMG">
                      </a>
      ...
      <div class="col-md-10 col-lg-4">
        <div class="p-l-10 p-rl-0-sr991 p-b-20">
          ...
          <div class="flex-c-s p-t-8">
            <a href="#">
              <img class="max-w-full" src="{{ asset('front_asset/images/banner-02.jpg') }}" alt="IMG">
            </a>
          </div>
