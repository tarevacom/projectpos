    ...
    <div class="row m-rl--1">
      <div class="col-md-6 p-rl-1 p-b-2">
        <div class="bg-img1 size-a-3 how1 pos-relative"
          style="background-image: url({{ asset('front_asset/images/post-01.jpg') }});">
        ...
        <div class="row m-rl--1">
          <div class="col-12 p-rl-1 p-b-2">
            <div class="bg-img1 size-a-4 how1 pos-relative"
              style="background-image: url({{ asset('front_asset/images/post-02.jpg') }});">
              <a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
          ...
          <div class="col-sm-6 p-rl-1 p-b-2">
            <div class="bg-img1 size-a-5 how1 pos-relative"
              style="background-image: url({{ asset('front_asset/images/post-03.jpg') }});">
              <a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
          ...
          <div class="col-sm-6 p-rl-1 p-b-2">
            <div class="bg-img1 size-a-5 how1 pos-relative"
              style="background-image: url({{ asset('front_asset/images/post-04.jpg') }});">
              <a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
